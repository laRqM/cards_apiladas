...
class CardsViewMagic extends StatefulWidget {
  const CardsViewMagic({
    super.key,
  ...
  @override
  CardsViewMagicState createState() => CardsViewMagicState();
}

class CardsViewMagicState extends State<CardsViewMagic> {
...
class _CardsViewMagicItems extends StatelessWidget {
  const _CardsViewMagicItems({
